...
<body class="sb-nav-fixed" style="background-image: url(<c:url value="/resources/dist/assets/img/mountain_road.jpg"/>); background-position: center; background-size: cover">
                        ...
                        <div class="col-xl-12">
                            <div class="card mb-4">
                                <div class="card-header" align="center" style="background-color: #6c757d; color: white">
                                        <a style="color: #ffffff" href="/forum/all?id=${item.id}">${item.name}</a>
                                </div>
                            </div>
                        </div>
                    </div>
